            ...
            <div class="card-body">
              <div class="border p-4 rounded">
                <div class="text-center">
                  <h3 class="text-uppercase">Đăng Nhập <span class="text-primary fw-bold">Laptop Gear</span></h3>
                  <p>
                ...
                <div class="form-body">
                  <div class="row g-3">
                    ...
                    <div class="col-12">
                      <div class="d-grid">
                        <button v-on:click="dangNhap()" class="btn btn-primary btn-pill">
    ...
    dangNhap() {
      axios.post("ps://laptopgear.onrender.com/api/khach-hang/dang-nhap", this.thong_tin_dang_nhap).then((res) => {
        if (res.data.status) {
          ...
          localStorage.setItem("khach_hang", JSON.stringify(res.data.data));
